(function () {
    ...
    if (typeof window.jsb === 'object') {
        let home = localStorage.getItem('home-page');
        let selectGame = localStorage.getItem('select-game');
        let isInGame = localStorage.getItem('in-game');
        let bootPath;
        ...
        if (selectGame) {
            // 选择了游戏，启动游戏
            bootPath = selectGame;
            // 记录一下进入游戏了，submitScore的时候再清楚它
            localStorage.setItem("in-game", "true");
        } else {
            // 否则从进入主页
            bootPath = home;
        ...
        if (bootPath) {
            ...
            var paths = JSON.parse(bootPath);
            console.log("bootPath:", paths);
